...
public class DataHelper {
	...
	public int UpdateUserInfo(String userName, Bitmap userIcon, String UserId) {
		...
		int id = db.update(MySQLiteHelper.TB_NAME, values, UserInfo.USERID + "=?", new String[]{UserId});
	...
	public int UpdateUserInfo(UserInfo user) {
		...
		int id = db.update(MySQLiteHelper.TB_NAME, values, UserInfo.USERID + "="
				+ user.getUserId(), null);
	...
	public Long SaveUserInfo(UserInfo user) {
		...
		values.put(UserInfo.TOKEN, user.getToken());
		values.put(UserInfo.TOKENSECRET, user.getTokenSecret());
		Long uid = db.insert(MySQLiteHelper.TB_NAME, UserInfo.ID, values);
